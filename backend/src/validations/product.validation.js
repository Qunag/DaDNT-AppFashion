...
const getProducts = {
  query: Joi.object().keys({
    ...
    maxPrice: Joi.number().min(0).optional().when('minPrice', {
      is: Joi.exist(),
    ...
    sortBy: Joi.string().valid('name', 'brand', 'price', 'createdAt').optional(),
...
const filterProducts = {
  query: Joi.object().keys({
    ...
    hasQuantity: Joi.boolean().optional().default(false).messages({
