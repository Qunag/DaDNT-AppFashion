...
| TC_DN_02     | Đăng nhập với sai mật khẩu             | - Tài khoản đã được đăng ký             | - Mở màn hình Đăng nhập <br> - Nhập email đúng, mật khẩu sai <br> - Nhấn "Đăng nhập"                       | Email: mesena686@gmail.com <br> Mật khẩu: sai123456     | Hiển thị thông báo: "Đăng nhập thất bại. Vui lòng nhập đúng mật khẩu"               | Đã hiển thị: "Vui lòng kiểm tra lại Email và Mật khẩu của bạn"   |
| TC_DN_03     | Đăng nhập với email không đúng định dạng | - Không yêu cầu tài khoản tồn tại       | - Nhập email sai định dạng <br> - Nhấn "Đăng nhập"                                                         | Email: meme123 @gmail.com <br> Mật khẩu: tu123456     | Hiển thị lỗi: "Đăng nhập thất bại. Vui lòng nhập đúng email"                         | Đã hiển thị: "Vui lòng kiểm tra lại Email và Mật khẩu của bạn"   |
| TC_DN_04     | Đăng nhập với email chưa đăng ký       | - Email chưa tồn tại trong hệ thống     | - Nhập email chưa đăng ký, mật khẩu bất kỳ <br> - Nhấn "Đăng nhập"                                         | Email: notexist@gmail.com <br> Mật khẩu: 123456     | Hiển thị lỗi: "Đăng nhập thất bại. Vui lòng kiểm tra email và mật khẩu."                                              | Đã hiển thị: "Vui lòng kiểm tra lại Email và Mật khẩu của bạn"    |
...
| ---------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| TC_OTP_01      | Nhập mã OTP không hợp lệ                                      | Người dùng đang ở màn hình OTP, chưa nhập đủ 6 chữ số                                | 1. Nhập mã dưới 6 chữ số (vd: “123”)<br>2. Hoặc nhập ký tự không phải số<br>3. Nhấn “Xác minh”                                                                                            | OTP: “123”                                                            | Hiển thị lỗi: "Lỗi. Vui lòng nhập đủ 6 chữ số OTP"                                                                   | Đã hiển thị: "Lỗi. Vui lòng nhập đủ 6 chữ số OTP"   |
...
| TC_QMK_06  | Bấm "SEND RESET LINK" khi đã nhập email và không có kết nối mạng | - Mất kết nối internet                                | - Nhập email hợp lệ <br> - Ngắt kết nối mạng <br> - Nhấn "SEND RESET LINK"                               | Email: [hoangthotu2192004@gmail.com](mailto:hoangthotu2192004@gmail.com)     | Hiển thị lỗi: "Không có kết nối mạng. Vui lòng kiểm tra kết nối Internet."                                                                  | Đã hiển thị: "Lỗi. Gửi liên kết đặt lại thất bại." |
message.txt
20 KB

## 5. Màn hình Home (Sau khi đăng nhập thành công)
...
| TC_Home_02      | Hiển thị banner - Không có banner | Đăng nhập thành công | Đăng nhập thành công | TH1: Không có bất kỳ dữ liệu banner (null). <br> TH2: Một vài banner có và một vài banner không có dữ liệu. | TH1: Phần hiển thị Banner sẽ hiển thị placeholder "Không có banner". <br> TH2: banner nào không có dữ liệu (null) hoặc lỗi thì sẽ bị ẩn đi, banner nào có dữ liệu thì vẫn hiện như bình thường. | TH1: Phần hiển thị Banner đã hiển thị placeholder "Không có banner" <br> TH2: Những banner không có dữ liệu hoặc bị lỗi đã bị ẩn đi, những banner có dữ liệu thì vẫn hiển thị bình thường. |
...
| TC_Home_10      | Lọc sản phẩm theo thương hiệu - Bình thường | 1. Đăng nhập thành công <br> 2. Bấm logo "Puma" | 1. Đăng nhập thành công <br> 2. Bấm logo "Puma" | Có từ 1 sản phẩm trở lên (VD: "Suede XL Denim", "Palermo"),... | Danh sách sản phẩm lọc theo hãng "Puma" (VD: "Suede XL Denim"). | Danh sách sản phẩm lọc theo thương hiệu Puma đã được hiển thị. |
| TC_Home_11      | Lọc sản phẩm - Không có kết quả | 1. Đăng nhập thành công <br> 2. Bấm logo "Balenciaga" (giả sử không có sản phẩm) | 1. Đăng nhập thành công <br> 2. Bấm logo "Balenciaga" | Không có sản phẩm nào của Balenciaga | Hiển thị: "Không có sản phẩm nào." | Đã hiển thị: "Không có sản phẩm nào." |
...
| TC008        | Hiển thị số lượng tồn kho đúng                | Có dữ liệu tồn kho        | Ấn vào sản phẩm ở màn hình home | 38 còn 99, 39 còn 0             | Hiển thị đúng tồn kho                                       | Đã hiển thị đúng tồn kho |
| TC009        | Tăng số lượng sản phẩm                        | Đã chọn màu + size        | Nhấn "+"                        | Số lượng từ 1 → 2 → ...         | Số lượng tăng                                               | Số lượng đã tăng |
| TC010        | Tăng số lượng vượt tồn kho                    | Tồn kho = n               | Nhấn "+" đến n + 1              | Số lượng = n + 1 > tồn kho      | Hiển thị thông báo: "Số lượng không hợp lệ"                 | Đã hiển thị thông báo: "Số lượng không hợp lệ" |
| TC011        | Giảm số lượng sản phẩm                        | Số lượng > 1              | Nhấn "-"                        | Số lượng từ 3 → 2               | Số lượng giảm                                               | Số lượng đã giảm |
| TC012        | Giảm số lượng sản phẩm dưới 1                 | Số lượng = 1              | Nhấn "-"                        | -                               | Số lượng vẫn là 1                                           | Số lượng vẫn là 1 |
| TC013        | Nhấn “Thêm vào giỏ hàng” thành công           | Chọn sản phẩm còn hàng    | Nhấn nút                        | Màu: Đen, Size: 38, Số lượng: 1 | Hiển thị thông báo thành công                               | Đã hiển thị thông báo thành công |
| TC014        | Mô tả sản phẩm dài vẫn hiển thị tốt           | Mô tả dài nhiều dòng      | Ấn vào sản phẩm ở màn hình home | Mô tả > 7 dòng                  | Có scroll, không tràn                                       | Đã có scroll, không tràn |


## 7. Màn hình menu (Sau khi ấn vào biểu tương menu ở màn hình Home)

| **Test Case ID** | **Mô Tả**                              | **Điều Kiện Tiên Quyết**  | **Bước Thực Hiện**              | **Trường Hợp Dữ Liệu**          | **Kết Quả Mong Đợi**                                        | **Kết Quả Thực Tế** |
| ---------------- | -------------------------------------- | ------------------------- | ------------------------------- | ------------------------------- | ----------------------------------------------------------- | ------------------- |
| TC001           | Kiểm tra điều hướng đến màn hình menu  | Người dùng đang ở màn hình Home, biểu tượng menu hiển thị | 1. Vào màn hình Home.<br>2. Nhấn vào biểu tượng menu (biểu tượng người) ở góc dưới bên phải. | Người dùng đã đăng nhập với tài khoản hợp lệ (Nguyên Phạm, nguyen030904@gmail.com). | Màn hình menu trượt vào từ trái, hiển thị thông tin hồ sơ người dùng (Nguyên Phạm, nguyen030904@gmail.com) và tùy chọn "Đăng Xuất". | Màn hình menu đã trượt vào từ trái và đã hiển thị thông tin hồ sơ người dùng (Nguyên Phạm, nguyen030904@gmail.com) và tùy chọn "Đăng Xuất". |
| TC002           | Kiểm tra hiển thị thông tin hồ sơ      | Người dùng đã đăng nhập với thông tin hồ sơ (Nguyên Phạm, nguyen030904@gmail.com). | 1. Vào màn hình Home.<br>2. Nhấn vào biểu tượng menu.<br>3. Quan sát phần thông tin hồ sơ. | Tài khoản có thông tin đầy đủ (tên, email, hình đại diện). | Màn hình menu hiển thị thông tin hồ sơ với tên "Nguyên Phạm", email "nguyen030904@gmail.com" và hình đại diện. | Màn hình menu đã hiển thị thông tin hồ sơ với tên "Nguyên Phạm", email "nguyen030904@gmail.com" và hình đại diện. |
| TC003           | Kiểm tra chức năng đăng xuất           | Người dùng đã đăng nhập và ở màn hình menu. | 1. Vào màn hình Home.<br>2. Nhấn vào biểu tượng menu.<br>3. Nhấn vào nút "Đăng Xuất". | Người dùng đang ở trạng thái đã đăng nhập. | Người dùng được đăng xuất và ứng dụng chuyển hướng đến màn hình đăng nhập. | Đã đăng xuất thành công và ứng dụng chuyển hướng đến màn hình đăng nhập. |
| TC004           | Kiểm tra điều hướng đến màn hình hồ sơ | Người dùng đã đăng nhập và ở màn hình menu. | 1. Vào màn hình Home.<br>2. Nhấn vào biểu tượng menu.<br>3. Nhấn vào phần thông tin hồ sơ. | Người dùng đã đăng nhập với tài khoản có thông tin hồ sơ đầy đủ. | Ứng dụng điều hướng đến màn hình hồ sơ người dùng. | Ứng dụng đã điều hướng đến màn hình hồ sơ người dùng. |





## 8. Màn Profile (màn hình hồ sơ người dùng)
| **Test Case ID** | **Mô Tả**                              | **Điều Kiện Tiên Quyết**            | **Bước Thực Hiện**                          | **Trường Hợp Dữ Liệu**              | **Kết Quả Mong Đợi**                              | **Kết Quả Thực Tế** |
|-----------------|----------------------------------------|-------------------------------------|------------------------------------------------|-------------------------------------|--------------------------------------------------|---------------------|
| TC_Profile_01   | Kiểm tra hiển thị thông tin hồ sơ - Bình thường | Người dùng đã đăng nhập thành công | 1. Đăng nhập với tài khoản (Nguyên Phạm, nguyen030904@gmail.com)<br>2. Nhấn vào phần thông tin hồ sơ. | Thông tin đầy đủ: Tên, Email, Mật khẩu, Số điện thoại, Địa chỉ | - Điều hướng tới màn hình hồ sơ của tôi <br> - Hiển thị tiêu đề "Hồ sơ của tôi" <br> - Hiển thị avatar<br>- Tên: "Nguyên Phạm"<br>- Email: "nguyen030904@gmail.com"<br>- Mật khẩu: "****"<br>- Số điện thoại: "0979836562"<br>- Địa chỉ: "Hà Nội" | Đã thực hiện được như mong đợi    |
| TC_Profile_02   | Kiểm tra nút quay lại | Người dùng đã đăng nhập và ở màn hình hồ sơ | 1. Vào màn hình "Hồ sơ của tôi"<br>2. Nhấn vào biểu tượng quay lại (mũi tên trái) | Không yêu cầu dữ liệu cụ thể | Điều hướng trở lại màn hình trước đó (VD: màn hình Home) | Đã điều hướng trở lại màn hình trước đó |
| TC_Profile_03   | Kiểm tra chức năng cập nhật thông tin | Người dùng đã đăng nhập và ở màn hình hồ sơ | 1. Vào màn hình "Hồ sơ của tôi"<br>2. Nhấn nút "Sửa thông tin" | - Tên: "Nguyen Pham"<br>- Email: "nguyen030904@gmail.com"<br>- Số điện thoại: "0979836562"<br>- Địa chỉ: "Hà Nội" | - Chuyển hướng đến màn hình chỉnh sửa thông tin<br>- Hiển thị các trường thông tin để chỉnh sửa | Đã thực hiện được như mong đợi |
| TC_Profile_04   | Kiểm tra chức năng đổi mật khẩu | Người dùng đã đăng nhập và ở màn hình hồ sơ | 1. Vào màn hình "Hồ sơ của tôi"<br>2. Nhấn nút "Đổi mật khẩu" | Mật khẩu hiện tại: "****" | - Chuyển hướng đến màn hình đổi mật khẩu<br>- Yêu cầu nhập mật khẩu mới | Đã thực hiện được như mong đợi |
| TC_Profile_05   | Kiểm tra hiển thị khi thiếu thông tin (Số điện thoại) | Người dùng đã đăng nhập với thông tin thiếu Số điện thoại | 1. Đăng nhập với tài khoản thiếu Số điện thoại<br>2. Vào màn hình "Hồ sơ của tôi" | - Tên: "Nguyen Pham"<br>- Email: "nguyen030904@gmail.com"<br>- Mật khẩu: "****"<br>- Số điện thoại: (null)<br>- Địa chỉ: "Hà Nội" | - Hiển thị "Đang cập nhật" | - Đã hiển thị "Đang cập nhật" |
| TC_Profile_06   | Kiểm tra hiển thị khi thiếu thông tin (Địa chỉ) | Người dùng đã đăng nhập với thông tin thiếu Địa chỉ | 1. Đăng nhập với tài khoản thiếu Địa chỉ <br> V2. Vào màn hình "Hồ sơ của tôi" | - Tên: "Nguyen Pham"<br>- Email: "nguyen030904@gmail.com"<br>- Mật khẩu: "****"<br>- Số điện thoại: "0979836562"<br>- Địa chỉ: (null) | - Hiển thị "Đang cập nhật" | - Đã hiển thị "Đang cập nhật" |

## 9.  Test case Sửa thông tin (sau khi nhấn vào nút Sửa thông tin ở màn hình Profile)
| **Test Case ID** | **Mô Tả**                                  | **Điều Kiện Tiên Quyết** | **Bước Thực Hiện**                                             | **Trường Hợp Dữ Liệu**                                            | **Kết Quả Mong Đợi**                                                  | **Kết Quả Thực Tế** |
| ---------------- | ------------------------------------------ | ------------------------ | -------------------------------------------------------------- | ----------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------- |
| TC001            | Cập nhật thông tin thành công              | Người dùng đã đăng nhập  | Nhập thông tin hợp lệ và nhấn "Lưu thông tin"                  | Tên: "Nguyễn A", SĐT: "0912345678", Địa chỉ: "Đà Nẵng"            | Hiển thị thông báo thành công, quay về Profile và refresh dữ liệu   | Đã hiển thị thông báo thành công, quay về Profile và refresh dữ liệu |
| TC002            | Không nhập tên                             | Người dùng đã đăng nhập  | Xóa hết nội dung trong ô "Tên" và nhấn "Lưu thông tin"         | Tên: "", SĐT: "0912345678", Địa chỉ: "Hà Nội"                     | Hiển thị lỗi "Vui lòng điền đầy đủ thông tin"                                      | Đã hiển thị lỗi "Vui lòng điền đầy đủ thông tin" |
| TC003            | Số điện thoại không hợp lệ (quá ngắn)      | Người dùng đã đăng nhập  | Nhập số điện thoại chỉ 5 ký tự                                 | "Nguyễn A", "09123", "Hà Nội"                                     | Hiển thị lỗi "Số điện thoại phải gồm đúng 10 chữ số"                   | Đã hiển thị lỗi "Số điện thoại phải gồm đúng 10 chữ số" |
| TC004            | Số điện thoại chứa ký tự               | Người dùng đã đăng nhập  | Nhập số điện thoại có ký tự                                | "Nguyễn A", "09**1234##", "Hà Nội"                                | Hiển thị lỗi "Số điện thoại phải gồm đúng 10 chữ số"                  | Đã hiển thị lỗi "Số điện thoại phải gồm đúng 10 chữ số" |
| TC005            | Địa chỉ để trống                           | Người dùng đã đăng nhập  | Xóa nội dung ô "Địa chỉ"                                       | "Nguyễn A", "0912345678", ""                                      | Hiển thị lỗi "Vui lòng điền đầy đủ thông tin"            | Đã hiển thị lỗi "Vui lòng điền đầy đủ thông tin" |
| TC006            | Nhấn lưu mà không thay đổi dữ liệu         | Người dùng đã đăng nhập  | Không chỉnh sửa gì, nhấn "Lưu thông tin"                       | Không thay đổi                                                    | Hiển thị thông báo thành công | Đã hiển thị thông báo thành công |
| TC008            | Nhấn nút quay lại (←)                      | Người dùng đã đăng nhập  | Nhấn nút back ở góc trên bên trái                              | Bất kỳ dữ liệu                                                    | Quay lại màn hình Profile                                             | Đã quay lại màn hình Profile |
| TC009            | Tên quá dài (trên 30 ký tự)                | Người dùng đã đăng nhập  | Nhập tên rất dài                                               | "Nguyễn Văn A Nguyễn Văn A Nguyễn Văn A Nguyễn Văn A Nguyễn", ... | Hiển thị lỗi Tên không được vượt quá 30 ký tự                                  | Đã hiển thị lỗi Tên không được vượt quá 30 ký tự |
| TC010            | Địa chỉ quá dài (trên 50 ký tự)                | Người dùng đã đăng nhập  | Nhập đia chỉ rất dài                                               | "Hà Nội Hà Nội Hà Nội Hà Nội...", ... | Hiển thị lỗi Địa chỉ không được vượt quá 50 ký tự                                  | Đã hiển thị lỗi Địa chỉ không được vượt quá 50 ký tự |
| TC011            | Các trường có ký tự đặc biệt (ví dụ emoji) | Người dùng đã đăng nhập  | Nhập tên hoặc địa chỉ có emoji hoặc ký tự đặc biệt             | "Nguyễn 😎", "0912345678", "🏠Hà Nội"                             | Hiện thị lỗi Tên không được chứa ký tự đặc biệt hoặc emoji hoặc Địa chỉ không được chứa ký tự đặc biệt hoặc emoji                                       | Đã hiện thị lỗi Tên không được chứa ký tự đặc biệt hoặc emoji hoặc Địa chỉ không được chứa ký tự đặc biệt hoặc emoji|


## 10. Đổi mật khẩu (Sau khi nhấn vào nút Đổi mật khẩu ở màn hình Profile)
| **Test Case ID** | **Mô Tả**                                   | **Điều Kiện Tiên Quyết** | **Bước Thực Hiện**                           | **Trường Hợp Dữ Liệu**       | **Kết Quả Mong Đợi**                                                                 | **Kết Quả Thực Tế** |
| ---------------- | ------------------------------------------- | ------------------------ | -------------------------------------------- | ---------------------------- | ------------------------------------------------------------------------------------ | ------------------- |
...
## 11. Test Cases Đặt hàng thành công 
| Test Case ID | Mô tả | Điều kiện tiên quyết | Bước thực hiện | Các trường hợp dữ liệu | Kết quả mong đợi | Kết quả thực tế |
|--------------|-------|----------------------|----------------|----------------------|------------------|----------|
...
## 13. Test Cases Đặt hàng thành công 
| Test Case ID | Mô tả | Điều kiện tiên quyết | Bước thực hiện | Các trường hợp dữ liệu | Kết quả mong đợi | Kết quả thực tế |
|--------------|-------|----------------------|----------------|----------------------|------------------|----------|
| TC_SC_01 | Hiển thị trang Đặt hàng thành công | - Người dùng đã đăng nhập.<br>- Người dùng đã đặt ít nhất 1 đơn hàng thành công. | - Vào app và chọn món đồ yêu thích.<br>- Kiểm tra thông tin và đặt hàng thành công. | - TH1: Nhấn "Xem đơn hàng".<br>- TH2: Nhấn "Tiếp tục mua hàng".  | - TH1: Hệ thống sẽ hiển thị thông tin đơn hàng bao gồm: Thông tin người nhận, thông tin mặt hàng (mẫu, màu, số lượng, size), phương thức giao hàng và phương thức thanh toán.<br>- TH2: Hệ thống sẽ đưa trở lại màn hình Home để tiếp tục mua sắm. | - TH1: Hệ thống đã hiển thị thông tin đơn hàng bao gồm: Thông tin người nhận, thông tin mặt hàng (mẫu, màu, số lượng, size), phương thức giao hàng và phương thức thanh toán.<br>- TH2: Hệ thống đã đưa trở lại màn hình Home để tiếp tục mua sắm.  |


## 14. Test Cases Đơn Hàng
...
## 15. Test Case Không Có Internet
| Test Case ID | Mô tả | Điều kiện tiên quyết | Bước thực hiện | Các trường hợp dữ liệu | Kết quả mong đợi | Kết quả thực tế |
|--------------|-------|----------------------|----------------|----------------------|------------------|----------|
| TC001 | Đang dùng ứng dụng mà mất kết nối Internet | Mất kết nối Internet | Ở cửa sổ bất kỳ tắt mạng của thiết bị đang sử dụng | | Màn hình ứng dụng sẽ bị lock tại thời điểm mất mạng. Nếu người dùng thao tác vào màn hình thiết bị thì sẽ hiện lên thông báo Không có kết nối Interet | |
